...
const APP_CSS: &str = r#"
window, .dialog { background-color: #0b1017; color: #dbe5f2; font-size: 13px; }
...
.grid-header { color: #8fa2b8; font-size: 11px; font-weight: 700; padding: 5px 8px; }
.grid-cell { font-size: 12px; padding: 3px 8px; }
